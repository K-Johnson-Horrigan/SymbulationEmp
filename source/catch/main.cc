...
#include "../test/sgp_mode_test/functional_tests/SGPDataNodes.test.cc"
#include "../test/sgp_mode_test/functional_tests/SGPHost_Tasks.test.cc"
#include "../test/sgp_mode_test/functional_tests/SGPHost.test.cc"
#include "../test/sgp_mode_test/functional_tests/SGPSymbiont_Tasks.test.cc"
#include "../test/sgp_mode_test/functional_tests/SGPSymbiont.test.cc"
...
#include "../test/sgp_mode_test/integration_tests/StressHost.test.cc"
