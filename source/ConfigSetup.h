...
EMP_BUILD_CONFIG(SymConfigBase,
    ...
    VALUE(START_GENOME_TYPE, int, 1, "1 for NOT starting host genomes, 2 for NAND, 3 for mixed NOT and NAND"),
    ...
    VALUE(SELECTION_SCHEME, size_t, 0, "Which selection scheme should be used to establish new generations (0-random, 1-truncated, 2-tournament)?"),
    ...
    VALUE(TOURNAMENT_SIZE, size_t, 4, "How many worlds should participate in each tournament?"),
