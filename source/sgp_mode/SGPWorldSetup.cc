...
/**
   * Input: The pointer to symbiont and host parents
   *
   * Output: Whether vertical transmission is permitted into this host's
   * child (whether parents have a task match)
   *
   * Purpose: To ensure that vertical transmission requires task matching
   */
