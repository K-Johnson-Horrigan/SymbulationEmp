...
EMP_EXTEND_CONFIG(SymConfigSGP, SymConfigBase,
  ...
  VALUE(TASK_PROFILE_COMPATIBILITY_MODE, std::string, "task-any-match", "How is task profile compatibility? Options are: off, task-any-match, task-perfect-match"),
  VALUE(TAG_COMPATIBILITY_MODE, std::string, "off", "How is tag compatibility determined? Options are: off, tag-less-cutoff, tag-less-or-equal-cutoff"),
  VALUE(INTERACTION_COMPATIBILITY_MODE, std::string, "always", "How is compatibility determined for interactions? always, task-match, tag-match"),
