...
EMP_EXTEND_CONFIG(SymConfigSGP, SymConfigBase,
  ...
  VALUE(INTERACTION_PROFILE_COMPATIBILITY_MODE, std::string, "always", "How is compatibility determined for interaction profiles? always, task-any-match, task-perfect-match, tag-probabilistic-match"),
